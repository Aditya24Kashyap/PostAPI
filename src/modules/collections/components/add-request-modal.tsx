    ...
    >
      <div className="space-y-4">
        ...
        <div>
          ...
          <label className="block text-sm font-medium mb-2 text-zinc-900 dark:text-zinc-200">Request name</label>
        ...
        <div>
          ...
          <label className="block text-sm font-medium mb-2 text-zinc-900 dark:text-zinc-200">Select location</label>


          {/* <div className="flex items-center space-x-2 text-sm text-zinc-400 mb-3"> */}
          <div className="flex items-center space-x-2 text-sm text-zinc-600 dark:text-zinc-400 mb-3">
              ...
              filteredCollections.map((collection) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <span className={`text-sm font-medium ${selectedCollectionId === collection.id ? "text-indigo-700 dark:text-indigo-200" : "text-zinc-900 dark:text-zinc-200"
                      }`}>
                      {collection.name}
                    </span>
                  </div>
        ...
        {selectedCollection && (
          <div className="p-3 bg-zinc-100 dark:bg-zinc-800/50 rounded-lg border border-zinc-300 dark:border-zinc-700">
            <div className="flex items-center space-x-2 text-sm">
              <span className="text-zinc-600 dark:text-zinc-400">Saving to:</span>
              <Folder className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
              <span className="text-indigo-700 dark:text-indigo-400 font-medium">{selectedCollection.name}</span>
            </div>
          </div>
        )}
